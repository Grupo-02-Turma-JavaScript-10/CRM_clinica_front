  ...
  return (
    <article className="group relative overflow-hidden rounded-[2.5rem] border border-[var(--accent)]/10 bg-[var(--surface)] transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_20px_50px_rgba(45,212,191,0.15)]">
      ...
      <div className="relative px-8 pb-10 flex flex-col items-center">
        <div className="relative -top-12 h-28 w-28 overflow-hidden rounded-[2.5rem] border-2 border-[#2DD4BF] bg-[var(--bg)] shadow-[0_10px_25px_rgba(45,212,191,0.2)] transition-all duration-500 group-hover:scale-110 group-hover:shadow-[0_0_40px_rgba(45,212,191,0.4)]">
          {member.photo && imgOk ? (
            <img
              src={member.photo}
              alt={member.name}
        ...
        <div className="text-center -mt-6">
          ...
          <div className="mt-6 flex justify-center gap-3">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="p-3 rounded-xl bg-[var(--bg)] border border-[var(--accent)]/10 text-[var(--text)] hover:text-[#2DD4BF] hover:border-[#2DD4BF]/50 transition-all shadow-sm"
            >
